...
class ClassificationMarkerTest {
    ...
    void invalidClassificationStringTest() {
        ...
        assertThrows(IllegalArgumentException.class, () -> { new Classification(SecurityClassification.OFFICIAL.name()); });
    }
    ...
    void classificationSetTest() {
        ...
        builder.official();
        assertTrue(builder.isValid().isEmpty());
        ClassificationMarker expectedMarker = new ClassificationMarker(false, Classification.official(), false, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
        ClassificationMarker actualMarker = builder.build();
        assertEquals(expectedMarker, actualMarker);
        
        builder.officialSensitive();
        assertTrue(builder.isValid().isEmpty());
        expectedMarker = new ClassificationMarker(false, Classification.official(), true, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
        actualMarker = builder.build();
        assertEquals(expectedMarker, actualMarker);
        
        builder.secret();
        assertTrue(builder.isValid().isEmpty());
        expectedMarker = new ClassificationMarker(false, Classification.secret(), false, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
        actualMarker = builder.build();
        assertEquals(expectedMarker, actualMarker);
        
        builder.topSecret();
        assertTrue(builder.isValid().isEmpty());
        expectedMarker = new ClassificationMarker(false, Classification.topSecret(), false, EMPTY, EMPTY, EMPTY, EMPTY, EMPTY);
        actualMarker = builder.build();
        assertEquals(expectedMarker, actualMarker);
